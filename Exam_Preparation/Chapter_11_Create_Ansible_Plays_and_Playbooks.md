...
|---|---|---|
| Packages | `dnf`, `dnf_module` | Install/remove packages |
...
- `ignore_errors: yes` continues execution even if task fails
...
### Mistake 3: Forgetting `become: yes`
...
| `become` | Privilege escalation | `become: yes` |
...
5. What is the difference between `ignore_errors: yes` and `failed_when: false`?
